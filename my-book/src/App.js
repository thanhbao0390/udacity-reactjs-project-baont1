      ...
      {showSearchPage ? (
        ...
        <div className="list-books">
          ...
          <div className="list-books-content">
            <div>
              <BookShelf title={CATEGORY.CURRENTLY_READING} books={booksCurrentlyReading} />
              <BookShelf title={CATEGORY.WANT_TO_READ} books={booksWanttoRead} />
              <BookShelf title={CATEGORY.READ} books={booksRead} />
            </div>
          </div>
